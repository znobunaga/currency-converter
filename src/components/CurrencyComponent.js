...
const CurrencyComponent = ({ initalCurrencyProp, targetCurrencyProp, changeInStartCurrencyProp, changeInEndCurrencyProp }) => {
  return (
    <div className="space-y-4">
      <div>
        <label className="block text-custom-grey font-medium">From:</label>
        <select value={initalCurrencyProp} onChange={changeInStartCurrencyProp} className="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-blue">
      ...
      <div>
        <label className="block text-custom-grey font-medium">To:</label>
        <select value={targetCurrencyProp} onChange={changeInEndCurrencyProp} className="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-blue">
